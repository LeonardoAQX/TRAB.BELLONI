...
from product.views import ProdutoListView, ProdutoCreateView, ProdutoDeleteView, ProdutoDetailView, ProdutoUpdateView
...
urlpatterns += [
	...
	path('product/add/', ProdutoCreateView.as_view(), name='produto-create'),
